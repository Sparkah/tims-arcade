...
import { gore, splats, player, enemies, particles } from '../state.js?v=bm7';
import { MAX_GORE, MAX_SPLATS, GORE_MUL } from '../config.js?v=bm7';
...
import { effectAllowed } from './particles.js?v=bm7';
