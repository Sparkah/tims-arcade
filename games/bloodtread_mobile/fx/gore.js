...
import { gore, splats, player, enemies, particles } from '../state.js?v=bm9';
import { MAX_GORE, MAX_SPLATS, GORE_MUL } from '../config.js?v=bm9';
...
import { effectAllowed } from './particles.js?v=bm9';
