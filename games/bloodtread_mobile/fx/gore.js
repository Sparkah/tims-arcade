...
import { gore, splats, player, enemies, particles } from '../state.js?v=bm4';
import { MAX_GORE, MAX_SPLATS, GORE_MUL } from '../config.js?v=bm4';
...
import { effectAllowed } from './particles.js?v=bm4';
