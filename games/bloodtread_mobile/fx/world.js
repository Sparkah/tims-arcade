...
import { booms, bubbles, corpses, veins, tracks, player, laser } from '../state.js?v=bm6';
import { MAX_BOOMS, MAX_BUBBLES, MAX_VEINS, CORPSE_CAP, TRACK_CAP } from '../config.js?v=bm6';
import { OLD_DEATH, VEIN_FX } from '../flags.js?v=bm6';
