...
import { state, player, econ, META, view, hudImages, SAVE_INTEREST } from '../state.js?v=bm3';
import { fmtTime } from '../lib/math.js?v=bm3';
import { TWO_PI } from '../lib/math.js?v=bm3';
import { WEAPONS } from '../data/weapons.js?v=bm3';
import { T_NAME, SPRITE_T_R, SPRITE_T_G, SPRITE_T_B } from '../data/enemies.js?v=bm3';   // for the DEV enemy-wave grid (name + per-type tint swatch)
import { MAXTIER, TRACKS } from '../data/upgrades.js?v=bm3';
import { weaponName, trackCost, trackEffect } from '../game/meta.js?v=bm3';
import { RARITY, R_MYTHIC, PITY_HARD, RELIC_SLOTS, SKINS, RELICS, STORE, GEAR_SLOTS, GEAR_TIERS, GEAR_MERGE } from '../data/loot.js?v=bm3';
import { SHARD_RELIC_COST } from '../systems/loot.js?v=bm3';
import { rects } from '../state.js?v=bm3';
import {
...
} from '../render/hud.js?v=bm3';
import { SKIN_BY_ID, RELIC_BY_ID, DEFAULT_TINT } from '../data/loot.js?v=bm3';
import { hud } from '../render/context.js?v=bm3';
import { CHEATS_ENABLED } from '../flags.js?v=bm3';
import { playTone } from '../audio.js?v=bm3';   // gacha roll ticks + payoff
