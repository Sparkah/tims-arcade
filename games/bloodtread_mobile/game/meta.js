...
import { META, econ } from '../state.js?v=bm5';
import { BALANCE } from '../balance.js?v=bm5';
import { clamp, clampInt } from '../lib/math.js?v=bm5';
import { WEAPON_BY_ID, WEAPON_ROW } from '../data/weapons.js?v=bm5';
import { MAXTIER, TIER_COST } from '../data/upgrades.js?v=bm5';
