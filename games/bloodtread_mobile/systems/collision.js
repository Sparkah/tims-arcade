...
import { player, state, view, enemies } from '../state.js';
import { BREAK_ENV } from '../flags.js';
import { ROCK_DENSITY } from '../config.js';
...
import { spawnParticle, spawnMote, spawnDecal } from '../fx/particles.js';
import { spawnSplat, spawnGoreSpray } from '../fx/gore.js';
import { spawnBoom } from '../fx/world.js';
