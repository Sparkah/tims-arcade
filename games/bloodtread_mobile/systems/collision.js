...
import { player, state, view, enemies } from '../state.js?v=bm2';
import { BREAK_ENV } from '../flags.js?v=bm2';
import { ROCK_DENSITY } from '../config.js?v=bm2';
...
} from './environment.js?v=bm2';
import { spawnParticle, spawnMote, spawnDecal } from '../fx/particles.js?v=bm2';
import { spawnSplat, spawnGoreSpray } from '../fx/gore.js?v=bm2';
import { spawnBoom } from '../fx/world.js?v=bm2';
