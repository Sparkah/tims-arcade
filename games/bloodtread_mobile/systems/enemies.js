...
import { enemies, player, state, particles, view, ebullets } from '../state.js';
import { BALANCE, enemyHpAt, enemyContactDmgAt } from '../balance.js';
import { MAX_ENEMIES, ENEMY_SCALE, TANK_VIS_R } from '../config.js';
...
import { effectAllowed, spawnParticle, spawnMote, spawnDecal } from '../fx/particles.js';
import { isTechType, spawnSplat, spawnGoreSpray, spawnGoreBurst } from '../fx/gore.js';
import { spawnBoom, spawnCorpse } from '../fx/world.js';
