...
import { enemies, player, state, particles, view, ebullets } from '../state.js?v=bm10';
import { BALANCE, enemyHpAt, enemyContactDmgAt } from '../balance.js?v=bm10';
import { MAX_ENEMIES, ENEMY_SCALE, TANK_VIS_R } from '../config.js?v=bm10';
import { TWO_PI } from '../lib/math.js?v=bm10';
import { GORE_FX } from '../flags.js?v=bm10';
import { rnd } from '../lib/rng.js?v=bm10';
import { playSfx, playSfxOneOf } from '../audio.js?v=bm10';
import { T_NAME, T_SPD, T_R, T_PAY, T_UNLOCK, T_WEIGHT, T_CAN_FIRE_BOLT, CONTACT_RANK, SPRITE_VIS_MULT, SPRITE_BODY_FILL } from '../data/enemies.js?v=bm10';
import { seenType } from '../state.js?v=bm10';
import { retargetLeechesAfterRemove } from './leech.js?v=bm10';
import { maybeDropEliteCache } from './loot.js?v=bm10';
import { triggerUnleash, spawnEnemyProj } from './combat.js?v=bm10';
import { collideEnemyObstacles, enemyObstacle, collidePlayerObstacles } from './collision.js?v=bm10';
import { addTrauma } from '../render/camera.js?v=bm10';
import { effectAllowed, spawnParticle, spawnMote, spawnDecal } from '../fx/particles.js?v=bm10';
import { isTechType, spawnSplat, spawnGoreSpray, spawnGoreBurst } from '../fx/gore.js?v=bm10';
import { spawnBoom, spawnCorpse } from '../fx/world.js?v=bm10';
