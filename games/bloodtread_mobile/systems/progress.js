...
import { player, state, econ, META, upgradeCounts, upgradePick, upgradeRollPool, upgradeRect } from '../state.js?v=bm6';
import { upgradeNames } from '../data/upgrades.js?v=bm6';
import { MAXTIER } from '../data/upgrades.js?v=bm6';
import { playPrestige } from '../audio.js?v=bm6';
import { rnd } from '../lib/rng.js?v=bm6';
import { WEAPON_BY_ID } from '../data/weapons.js?v=bm6';
import { view } from '../state.js?v=bm6';
import { playTone } from '../audio.js?v=bm6';
import { bumpTier, currentWeaponTier, trackCost } from '../game/meta.js?v=bm6';
import { BALANCE } from '../balance.js?v=bm6';
import { saveMeta } from '../persistence.js?v=bm6';
import { syncTankTiersFromMeta, recomputeWeaponStats } from './player.js?v=bm6';
import { trackAnalyticsUpgradePick } from '../analytics.js?v=bm6';
