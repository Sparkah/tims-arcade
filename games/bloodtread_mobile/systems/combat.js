...
import { bullets, ebullets, enemies, player, state, laser, econ, view } from '../state.js';
import { BALANCE } from '../balance.js';
import { MAX_BULLETS, MAX_EBULLETS, MAX_BUBBLES, UNLEASH_TIME } from '../config.js';
import { TWO_PI, clampInt } from '../lib/math.js';
import { rnd } from '../lib/rng.js';
import { GOD } from '../flags.js';
import { playSfx, playSfxOneOf } from '../audio.js';
import { WEAPON_ROW } from '../data/weapons.js';
import { currentWeapon, currentWeaponTier, weaponRow, tankRageLevel } from '../game/meta.js';
import { laserRangeWorld, addTrauma } from '../render/camera.js';
import { killEnemy } from './enemies.js';
import { obstacleHitAt, damageCurrentObstacle } from './collision.js';
import { effectAllowed, spawnParticle } from '../fx/particles.js';
import { spawnGoreSpray } from '../fx/gore.js';
import { spawnBoom, spawnVeinTrail, spawnRageBubble } from '../fx/world.js';
