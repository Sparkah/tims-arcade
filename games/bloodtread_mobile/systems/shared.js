...
import { state, player } from '../state.js?v=bm2';
import { BALANCE, spawnCountAt } from '../balance.js?v=bm2';
import { MAX_ENEMIES, MAX_LEECHES } from '../config.js?v=bm2';
import { LEECH_FX, TOUCH_DEVICE } from '../flags.js?v=bm2';
