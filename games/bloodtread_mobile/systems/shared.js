...
import { state, player } from '../state.js?v=bm8';
import { BALANCE, spawnCountAt } from '../balance.js?v=bm8';
import { MAX_ENEMIES, MAX_LEECHES } from '../config.js?v=bm8';
import { LEECH_FX, TOUCH_DEVICE } from '../flags.js?v=bm8';
