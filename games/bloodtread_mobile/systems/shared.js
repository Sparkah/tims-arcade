...
import { state, player } from '../state.js?v=bm10';
import { BALANCE, spawnCountAt } from '../balance.js?v=bm10';
import { MAX_ENEMIES, MAX_LEECHES } from '../config.js?v=bm10';
import { LEECH_FX, TOUCH_DEVICE } from '../flags.js?v=bm10';
