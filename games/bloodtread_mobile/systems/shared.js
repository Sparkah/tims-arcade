...
import { state, player } from '../state.js?v=bm9';
import { BALANCE, spawnCountAt } from '../balance.js?v=bm9';
import { MAX_ENEMIES, MAX_LEECHES } from '../config.js?v=bm9';
import { LEECH_FX, TOUCH_DEVICE } from '../flags.js?v=bm9';
