...
import { WEAPONS, WEAPON_BY_ID } from './data/weapons.js?v=bm6';
import { RELIC_SLOTS } from './data/loot.js?v=bm6';
import { currentWeaponTier, syncLegacyCannonMeta } from './game/meta.js?v=bm6';
