...
import { WEAPONS, WEAPON_BY_ID } from './data/weapons.js?v=bm7';
import { RELIC_SLOTS } from './data/loot.js?v=bm7';
import { currentWeaponTier, syncLegacyCannonMeta } from './game/meta.js?v=bm7';
