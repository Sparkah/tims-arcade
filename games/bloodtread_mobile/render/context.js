...
import { SPRITE_LOD } from '../flags.js?v=bm10';
import { player, view, sprites, enemies } from '../state.js?v=bm10';
import { perf } from '../core/time.js?v=bm10';
import { worldToScreenX, worldToScreenY } from './camera.js?v=bm10';
