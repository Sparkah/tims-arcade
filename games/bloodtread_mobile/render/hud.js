...
import { hud } from './context.js?v=bm8';
import {
...
import { clamp, clampInt, fmtTime, TWO_PI } from '../lib/math.js?v=bm8';
import {
  NO_HUD, DEBUG, DIAG, COLLIDERS, OLD_SPRITES, GORE_FX, BREAK_ENV
} from '../flags.js?v=bm8';
import { upgradeNames, upgradeDesc } from '../data/upgrades.js?v=bm8';
import { WEAPON_TURRET_CELL } from '../data/weapons.js?v=bm8';
import { perf, ring, ringState } from '../core/time.js?v=bm8';
import { weaponAtlasTier, weaponRow } from '../game/meta.js?v=bm8';
import { desiredEnemies, currentLeechLevel } from '../systems/shared.js?v=bm8';
import { layoutUpgradeCards } from '../systems/progress.js?v=bm8';
import { drawMenu, drawShop, drawCheat, drawGameOver, drawPause, drawWin, drawVault, drawReveal, drawStore } from '../ui/screens.js?v=bm8';
import { drawIntroHint } from '../tutorial.js?v=bm8';   // first-run drive/auto-fire hint (no-op once seen)
...
export var BT_IRON_LO = '#241f1a';
  ...
  export function renderHud() {
    ...
    drawIntroHint();   // TUTORIAL: one-step drive + auto-fire hint on the first run (tutorial.js); no-op once seen
