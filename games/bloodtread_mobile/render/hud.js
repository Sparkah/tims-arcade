...
import { hud } from './context.js?v=bm4';
import {
...
import { clamp, clampInt, fmtTime, TWO_PI } from '../lib/math.js?v=bm4';
import {
  NO_HUD, DEBUG, DIAG, COLLIDERS, OLD_SPRITES, GORE_FX, BREAK_ENV
} from '../flags.js?v=bm4';
import { upgradeNames, upgradeDesc } from '../data/upgrades.js?v=bm4';
import { WEAPON_TURRET_CELL } from '../data/weapons.js?v=bm4';
import { perf, ring, ringState } from '../core/time.js?v=bm4';
import { weaponAtlasTier, weaponRow } from '../game/meta.js?v=bm4';
import { desiredEnemies, currentLeechLevel } from '../systems/shared.js?v=bm4';
import { layoutUpgradeCards } from '../systems/progress.js?v=bm4';
import { drawMenu, drawShop, drawCheat, drawGameOver, drawPause, drawWin, drawVault, drawReveal, drawStore } from '../ui/screens.js?v=bm4';
