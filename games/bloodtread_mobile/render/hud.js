...
import { hud } from './context.js?v=bm7';
import {
...
import { clamp, clampInt, fmtTime, TWO_PI } from '../lib/math.js?v=bm7';
import {
  NO_HUD, DEBUG, DIAG, COLLIDERS, OLD_SPRITES, GORE_FX, BREAK_ENV
} from '../flags.js?v=bm7';
import { upgradeNames, upgradeDesc } from '../data/upgrades.js?v=bm7';
import { WEAPON_TURRET_CELL } from '../data/weapons.js?v=bm7';
import { perf, ring, ringState } from '../core/time.js?v=bm7';
import { weaponAtlasTier, weaponRow } from '../game/meta.js?v=bm7';
import { desiredEnemies, currentLeechLevel } from '../systems/shared.js?v=bm7';
import { layoutUpgradeCards } from '../systems/progress.js?v=bm7';
import { drawMenu, drawShop, drawCheat, drawGameOver, drawPause, drawWin, drawVault, drawReveal, drawStore } from '../ui/screens.js?v=bm7';
