...
function resize() {
  ...
  cx = W / 2; cy = H / 2;
  // Yandex 1.6.2.1 — canvas must FILL the viewport on both axes (no empty
  // bands). Use Math.max so the design box always covers the screen; the
  // game centers its world on (cx,cy) and lets the longer axis overscan.
