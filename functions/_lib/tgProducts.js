export const PRODUCTS_BY_GAME = Object.freeze({
  ...
  bloodtread: Object.freeze({
    ...
    box_single: Object.freeze({
      title: 'Blood Box',
      description: 'One Gore Cache pull. Guaranteed Vein or better.',
      amount: 49,
      ton: '0.40',
      nanotons: '400000000',
      deliver: 'box_single',
    }),
    box_legendary: Object.freeze({
      title: 'Relic Box',
      description: 'One Gore Cache pull. Guaranteed a Relic.',
      amount: 199,
      ton: '1.60',
      nanotons: '1600000000',
      deliver: 'box_legendary',
    }),
    box_bounty: Object.freeze({
      title: 'Bounty Crate',
      description: 'A gear piece in every slot, extras, and a hull skin.',
      amount: 499,
      ton: '4.00',
      nanotons: '4000000000',
      deliver: 'box_bounty',
    }),
    mythic_skin: Object.freeze({
      title: 'Gorelord Hull (Mythic)',
      description: 'Mythic hull skin, bought outright.',
      amount: 999,
      ton: '8.00',
      nanotons: '8000000000',
      deliver: 'mythic_skin',
    }),
    mythic_relic: Object.freeze({
      title: 'Blood Crown (Mythic)',
      description: 'Mythic signature relic: +25 hull, +12% damage.',
      amount: 1999,
      ton: '16.00',
      nanotons: '16000000000',
      deliver: 'mythic_relic',
    }),
    mythic_ultimate: Object.freeze({
      title: 'Apex Predator (Mythic Bundle)',
      description: 'Mythic skin + crown + every relic + 250,000 blood.',
      amount: 4999,
      ton: '40.00',
      nanotons: '40000000000',
      deliver: 'mythic_ultimate',
    }),
